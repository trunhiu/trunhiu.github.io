          ...
          >
            <ul className="navbar-nav">
              <li className="nav-item">
                <NavLink className="nav-link text-white" to="/lo-trinh">
                  LỘ TRÌNH
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link text-white" to="/khoa-hoc">
                  KHÓA HỌC
                </NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink className="nav-link text-white" to="/bai-viet">
                  BLOG
                </NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link text-white" to="/trung-tam">
                  VỀ CHÚNG TÔI
                </NavLink>
              </li>
            </ul>
                ...
                {auth.id && (
                  <div className="dropdown">
                    ...
                    >
                      ...
                      <li>
                        <Link className="dropdown-item" to="/bao-mat-tai-khoan">
                          Bảo mật tài khoản
                        </Link>
                      </li>
                      <li>
